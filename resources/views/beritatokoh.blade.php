  ...
  <main id="content" class="scroll-smooth">
          ...
          <div class="lg:col-span-1">
            ...
            <div class="mt-6 bg-white p-5 rounded-xl shadow-sm">
              ...
              <ul class="space-y-2">
                ...
                <li class="grid grid-cols-2 gap-2">
                  <span class="font-medium text-gray-800">Lahir</span>
                  <span class="text-gray-700">{{ $lahir }}</span>
                </li>
                @if(!empty($wafat) && $wafat !== '-')
                  <li class="grid grid-cols-2 gap-2">
                    <span class="font-medium text-gray-800">Wafat</span>
                    <span class="text-gray-700">{{ $wafat }}</span>
                  </li>
                @endif
                <li class="grid grid-cols-2 gap-2">
                  <span class="font-medium text-gray-800">Dikenal</span>
    ...
    <section class="py-12 bg-gray-200">
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <!-- Tambahkan justify-center agar item grid rata tengah -->
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-center">
          @php
            // Tampilkan 3 tokoh lainnya (selain yang sedang aktif)
            $count = 0;
          @endphp

          @foreach($tokohData as $key => $data)
            @if($key !== $tokohKey && $count < 3)
