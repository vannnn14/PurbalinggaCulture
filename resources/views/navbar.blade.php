...
<body>
    <!-- Navbar Start -->
    <section>
        <nav id="nav-menu" class="relative bg-batik  items-center justify-between border-b text-white px-6 py-4" >
                    ...
                    <ul class="flex items-center space-x-20">
                        ...
                        <li x-data="{open: false}" class="relative">
                            <button @click="open = !open" 
                                    class="focus:outline-none px-4 py-2 rounded-md transition-colors duration-300
