...
<section class="py-14 md:py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 text-center" data-aos="fade-up">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      {{-- Tari Lengger --}}
      <a href="{{ route('seni.show','tari-lengger') }}"
         class="block bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden"
         data-aos="fade-up" aria-label="Buka artikel Tari Lengger">
      ...
      {{-- Kuda Lumping --}}
      <a href="{{ route('seni.show','kuda-lumping') }}"
         class="block bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden"
         data-aos="fade-up" data-aos-delay="200" aria-label="Buka artikel Kuda Lumping">
      ...
      {{-- Tradisi Begalan --}}
      <a href="{{ route('seni.show','tradisi-begalan') }}"
         class="block bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden"
         data-aos="fade-up" data-aos-delay="400" aria-label="Buka artikel Tradisi Begalan">
...
<section class="py-14 md:py-16 bg-gray-50">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 text-center" data-aos="fade-up">
    ...
    <div class="grid sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
      {{-- Nyadran --}}
      <a href="{{ route('tradisi.show','nyadran') }}"
         class="block bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden"
         data-aos="zoom-in">
      ...
      {{-- Sedekah Bumi --}}
      <a href="{{ route('tradisi.show','sedekah-bumi') }}"
         class="block bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden"
      ...
      {{-- Ujungan --}}
      <a href="{{ route('tradisi.show','ujungan') }}"
         class="block bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden"
      ...
      <a href="{{ route('tradisi.show','tradisi-adat-lainnya') }}"
         class="block bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden"
...
<section class="py-14 md:py-16">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 text-center" data-aos="fade-up">
    ...
    <div class="grid md:grid-cols-3 gap-6 md:gap-8">
      {{-- Sapu Glagah --}}
      <a href="{{ route('kerajinan.show', 'sapu-glagah') }}"
         class="bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden block"
         data-aos="flip-left">
      ...
      {{-- Blangkon Soedirman --}}
      <a href="{{ route('kerajinan.show', 'blangkon-soedirman') }}"
         class="bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden block"
      ...
      {{-- Wayang Suket --}}
      <a href="{{ route('kerajinan.show', 'wayang-suket') }}"
         class="bg-white rounded-xl shadow hover:shadow-xl transition overflow-hidden block"
