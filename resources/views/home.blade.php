...
<body class="bg-[#fef7eb] text-gray-900 font-sans">
  ...
  <section class="relative bg-gradient-to-r from-amber-900 to-yellow-800 text-white overflow-hidden">
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 120" preserveAspectRatio="none" class="w-full h-20 md:h-28">
        <path fill="#fdf6ec" fill-opacity="1" d="M0,64 C360,120 1080,0 1440,64 L1440,120 L0,120 Z"></path>
      </svg>
    </div>
    ...
    <div class="relative max-w-7xl mx-auto px-6 py-28 flex flex-col md:flex-row items-center gap-10">
      <div class="flex-1 space-y-6" data-aos="fade-right">
        ...
        <a href="#menu-utama" class="inline-block bg-amber-600 hover:bg-amber-700 transition text-white px-8 py-3 rounded-lg font-semibold shadow-lg">
          Mulai Jelajahi →
        </a>
      </div>
    </div>
  ...
  <section id="menu-utama" class="max-w-7xl mx-auto px-6 py-20">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <a href="{{ $menu['link'] }}" 
         class="group relative block rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-500" data-aos="zoom-in">
  ...
  <section class="bg-amber-50 py-16" data-aos="fade-up">
    <div class="max-w-4xl mx-auto text-center space-y-6">
      ...
      <div class="flex justify-center">
        <a href="{{ url('/bahasa') }}">
          <img src="/images/translate.png" alt="Translate" class="w-28 hover:scale-110 transition duration-500 ease-in-out mx-auto drop-shadow-md">
        </a>
      </div>
  ...
  <section class="max-w-7xl mx-auto px-6 py-20" data-aos="fade-up">
    ...
    <div class="swiper artikelSwiper">
      <div class="swiper-wrapper">
        @foreach ([ 
          ['judul' => 'Mengenal Batik Purbalingga', 'isi' => 'Mengenal batik khas Purbalingga yang unik dan bersejarah.', 'img' => 'batik.jpg', 'url' => url('/batik')],
          ['judul' => 'Tradisi Kuda Lumping', 'isi' => 'Kesenian rakyat penuh makna spiritual dan kebersamaan.', 'img' => 'ebeg.jpg', 'url' => route('seni.show','kuda-lumping')],
          ['judul' => 'Kuliner Tempe Mendoan', 'isi' => 'Tempe mendoan yang gurih, tipis, dan nikmat disantap hangat.', 'img' => 'mendoan1.jpg', 'url' => route('kuliner.show','tempe-mendoan-gurih-tipis-hangat')],
        ] as $artikel)
        <div class="swiper-slide">
          <a href="{{ $artikel['url'] }}" class="block bg-white shadow-md rounded-xl overflow-hidden hover:shadow-2xl transition duration-500 h-full flex flex-col">
  ...
  <section class="bg-amber-100 py-20">
    <div class="max-w-4xl mx-auto text-center" data-aos="fade-up">
      ...
      <span class="font-semibold text-amber-800">— Team PurbaCulture </span>
    </div>
  </section>
